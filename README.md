...
│
├── report_part1.txt                       # Part 1: Problem Framing (comprehensive)
│
├── part2_eda.ipynb                        # Part 2: EDA & Insights (Jupyter notebook)
│
├── part3_win_rate_analysis.ipynb          # Part 3: Win Rate Driver Analysis (Option B)
│
...
```bash
jupyter nbconvert --to notebook --execute part2_eda.ipynb --output part2_executed.ipynb
```
...
```bash
# Run Part 3 notebook
jupyter notebook part3_win_rate_analysis.ipynb
```
...
| ---- | ----------------------------------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------- |
| 1    | Problem Framing ([report_part1.txt](report_part1.txt))                                    | Complete | Root cause analysis, 6 hypotheses, custom metrics definitions                     |
| 2    | EDA & Insights ([part2_eda.ipynb](part2_eda.ipynb))                                       | Complete | 4 key insights, 2 custom metrics (PVS, SMI), 10+ visualizations                   |
| 3    | Win Rate Driver Analysis ([part3_win_rate_analysis.ipynb](part3_win_rate_analysis.ipynb)) | Complete | Impact scoring, attribution model, Random Forest validation, actionable playbooks |
...
- **Causal inference**: Propensity score matching to test if velocity _causes_ wins
